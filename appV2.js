...
else if(argv._[0]==='read' && argv.title!=='')
{
    ...
    console.log('\n\n---------FOR ADDING NEW LIST :\n'+
    'node noteApp.js add -t newtiltle -b newbody\n'+ 
     'or\n'+
     'node noteApp.js add --tille newtitle --body newbody\n\n\n'+
    '---------FOR LIST ALL NOTE\n'+
    'node Note-app.js list\n\n\n'+
    '---------FOR ROMOVE A NOTE\n'+
    'node noteApp.js remove --tille title\n'+
    'or\n'+
    'node noteApp.js remove -t title\n\n\n'+
    '---------FOR READ A SPECIFIC NOTE\n'+
    'node noteApp.js read --tille title\n'+
    'or\n'+
    'node noteApp.js read -t title\n\n\n')
